          ...
          children: <Widget> [
            ...
            // Card(
              ...
              ListTile(
                ...
                title: const Text('Dashboard'),titleTextStyle: const TextStyle(color: Colors.white),
                leading: const Icon(Icons.dashboard_rounded),
                iconColor: Colors.white,
                onTap: (){
                 
                  // Navigator.push(context, 
                  // MaterialPageRoute(builder: (context)=>WeatherDetail(weather: , formattedDate: formattedDate, formattedTime: formattedTime)));
                },
              ),
            // ),
          ],
